 ...
 */
LEDMatrixDriver led(LEDMATRIX_SEGMENTS, LEDMATRIX_CS_PIN, LEDMatrixDriver::flipDirection::flipColumn | LEDMatrixDriver::flipDirection::flipRow);
...
void writeNext()
{
  ...
  // We need to handle space character since ignoring whitespace.
  if (asc == 0)
  {
  ...
  led.setColumn(LEDMATRIX_WIDTH - 1, font[asc][colIndex]);
